...
static void ADC_prvClockEnable(ADC_HandleType * pxADC)
{
    ...
    {
        RCC_vClockEnable(RCC_POS_ADC12 + ucIndex);
    }
...
#else
#define ADC_prvClockEnable(HANDLE)    (RCC_vClockEnable(RCC_POS_ADC1))
#define ADC_prvClockDisable(HANDLE)   (RCC_vClockDisable(RCC_POS_ADC1))
#endif
