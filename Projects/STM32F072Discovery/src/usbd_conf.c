...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
    ...
    /* Configuration for wake-up line */
    {
        EXTI_InitType exti;
        exti.Edge = EDGE_RISING;
        exti.Reaction = REACTION_IT;
        exti.ITCallback = NULL;

        XPD_EXTI_Init(USB_WAKEUP_EXTI_LINE, &exti);
    }
    ...
    /* USB init setup */
    {
        USB_InitType init;
        init.SOF = ENABLE;
        init.LowPowerMode = ENABLE;
        init.LinkPowerMgmt = ENABLE;
