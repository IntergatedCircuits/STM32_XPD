...
typedef enum
{
  ...
  FLASH_OPERATION_ERASE_BANK1 = FLASH_CR_MER1,/*!< FLASH bank1 mass erase operation */
#ifdef FLASH_CR_MER2
  FLASH_OPERATION_ERASE_BANK2 = FLASH_CR_MER2,/*!< FLASH bank2 mass erase operation */
#endif
...
typedef enum
{
    ...
    FLASH_ERROR_FAST_MISS = FLASH_SR_MISERR, /*!< Fast Programming Data Miss error */
    FLASH_ERROR_PROGRAM   = FLASH_SR_PROGERR,/*!< Programming value error */
    FLASH_ERROR_SIZE      = FLASH_SR_SIZERR, /*!< Programming size error */
    FLASH_ERROR_FAST      = FLASH_SR_FASTERR,/*!< Fast Programming error */
    FLASH_ERROR_OPTIONVAL = FLASH_SR_OPTVERR,/*!< Option validity error */
}FLASH_ErrorType;
 ...
 *            @arg PROGERR:     Programming error flag
 *            @arg WRPERR:      Write protected error flag
 *            @arg PGAERR:      Programming Alignment error flag
 *            @arg SIZERR:      Programming Size error flag
 *            @arg PGSERR:      Programming Sequence error flag
 *            @arg MISERR:      Fast programming data miss error flag
 *            @arg FASTERR:     Fast programming error flag
 *            @arg RDERR:       Read protected error flag
 *            @arg OPTVERR:     Option validity error flag
 */
